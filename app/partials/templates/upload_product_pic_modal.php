    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <div class="container px-5 pb-2 pt-5 mb-4">
                ...
                <div class="row">
                    <div class="col">
                        <form action='<?= isset($_GET['productid']) ? "../controllers/process_edit_product_primary_pic.php" : "../controllers/process_upload_product_primary_pic.php" ?>'  method="POST" enctype="multipart/form-data">
