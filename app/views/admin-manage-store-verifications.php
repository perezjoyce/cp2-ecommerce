            ...
            <div class="col">
                ...
                <div class='container p-5 rounded' style='background:white;'>
                    <div class="row mx-0">
                        <div class="col-lg-6 col-md-4 col-sm-12">
                            <h4>Manage Shop Verification</h4>
                        </div>
                        <div class="col">
                ...
                <div class="container px-5 pb-5 rounded" style='background:white;'>
                    ...
                    <?php 
                        ...
                        $sql = " SELECT s.id AS 'store_id', s.logo, s.name, s.date_created, s.with_permit, s.store_address, s.user_id, u.first_name, u.last_name 
                                FROM tbl_stores s 
                                JOIN tbl_users u 
                                ON s.user_id=u.id  WHERE s.with_permit = 1";
                                                ...
                                                <div class='py-3 text-gray'>
                                                    <div class="dropdown show">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                            ...
                                                            <a class="dropdown-item btn_view_permit" href="#" data-href='<?= BASE_URL ."/app/partials/templates/view_permit_modal.php?id=". $storeId?>'>
                                                                <small>VIEW PERMIT</small>
                                                            </a>
                                                            
                                                            <a class="dropdown-item btn_verify" data-storeid='<?=$storeId?>' data-userid='<?= $sellerId ?>' href="#" data-username='<?=$owner?>' data-isseller='yes' data-storename='<?=$storeName?>'>
                                                                <small>SET AS VERIFIED SELLER</small>
                                                            </a>
